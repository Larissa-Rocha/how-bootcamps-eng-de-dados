...
#Princípios:
# - Responsabilidade única: cada funcão deve ter uma única responsabilidade
# - Aberto/fechado: a classe deve ser aberta para extensão e fechada para modificação 
